...
namespace DIO.Series
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
			...
			Console.WriteLine("Obrigado por utilizar nossos serviços, volte sempre. ;D");
			Console.ReadLine();
        }
        ...
        private static void AtualizarSerie()
		{
			...
			Console.Write("Digite o gênero entre as opções acima disponivel: ");
		...
		{
			Console.WriteLine();
			Console.WriteLine("Brenner's Séries a seu dispor!!! ;D ");
